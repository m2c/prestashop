<p class="payment_module">
	...
	<a href="javascript:$('#webcash_form').submit();" title="{l s='Pay with Kiple' mod='kiple'}">

		<img src="{$module_template_dir}weblogo.gif" alt="{l s='Pay with Kiple' mod='kiple'}" />

		{l s='Pay with kiple' mod='kiple'}
...
{else}
	...
	<input type="hidden" name="item_name_1" value="{l s='My cart' mod='kiple'}" />
